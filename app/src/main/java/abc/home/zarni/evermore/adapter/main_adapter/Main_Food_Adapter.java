...
public class Main_Food_Adapter   extends RecyclerView.Adapter<Main_Food_Adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            Glide.with(context).load(R.drawable.turkey).into(img);
...
//            add.setText("ထည့်မယ်");
    ...
    public Main_Food_Adapter(Context context, List<Food> notesList) {
        this.context = context;
        this.notesList = notesList;
    }

    @Override
    public Main_Food_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_item, parent, false);

        return new Main_Food_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Main_Food_Adapter.MyViewHolder holder, int position) {
       final Food note = notesList.get(position);
