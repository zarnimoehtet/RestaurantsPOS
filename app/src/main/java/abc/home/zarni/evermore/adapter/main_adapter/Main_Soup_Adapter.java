...
public class Main_Soup_Adapter  extends RecyclerView.Adapter<Main_Soup_Adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            Glide.with(context).load(R.drawable.soup).into(img);
...
//            add.setText("ထည့်မယ်");
    ...
    public Main_Soup_Adapter(Context context, List<Soup> notesList) {
        this.context = context;
        this.notesList = notesList;
    }

    @Override
    public Main_Soup_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_item, parent, false);

        return new Main_Soup_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Main_Soup_Adapter.MyViewHolder holder, int position) {
        final Soup note = notesList.get(position);
