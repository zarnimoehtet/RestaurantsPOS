...
public class Main_Salad_Adapter  extends RecyclerView.Adapter<Main_Salad_Adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            Glide.with(context).load(R.drawable.salad).into(img);
...
//            add.setText("ထည့်မယ်");
    ...
    public Main_Salad_Adapter(Context context, List<Salad> notesList) {
        this.context = context;
        this.notesList = notesList;
    }

    @Override
    public Main_Salad_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_item, parent, false);

        return new Main_Salad_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Main_Salad_Adapter.MyViewHolder holder, int position) {
       final Salad note = notesList.get(position);
