...
public class Main_Drink_Adapter   extends RecyclerView.Adapter<Main_Drink_Adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            Glide.with(context).load(R.drawable.drink).into(img);
//
...
//            add.setTypeface(Utils.getMMTypeface(context));
    ...
    public Main_Drink_Adapter(Context context, List<Drink> notesList) {
        this.context = context;
        this.notesList = notesList;
    }

    @Override
    public Main_Drink_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_item, parent, false);

        return new Main_Drink_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Main_Drink_Adapter.MyViewHolder holder, int position) {
       final Drink note = notesList.get(position);
